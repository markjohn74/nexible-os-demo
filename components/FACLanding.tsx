    ...
    <div className="animate-fade-in max-w-6xl mx-auto py-8">
      <div className="text-center mb-16">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight">
          Unlock the <span className="text-transparent bg-clip-text bg-gradient-to-r from-nexible-gold to-amber-200">Fund IV Alpha Graph</span>
        </h1>
        <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
          The Founder Access Circle is a high-performance environment designed for select portfolio members to leverage proprietary Investible resources and commercial networks.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-20">
        ...
        <div className="bg-nexible-panel border border-slate-700 rounded-2xl p-8 hover:border-slate-500 transition-all group">
          ...
          <p className="text-slate-400 text-sm leading-relaxed mb-6">
            Direct access to the Investible LP network and global corporate partners. Every introduction is measured for commercial impact.
          </p>
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 rounded-3xl p-10 flex flex-col items-center text-center shadow-2xl relative overflow-hidden">
         ...
         <p className="text-slate-400 max-w-2xl mb-10 leading-relaxed">
            Access to the Founder Access Circle is strictly managed by the Investible Fund Administration. Eligibility is determined by portfolio status, network contribution score, and adherence to the commercial success fee framework.
         </p>
      ...
      <div className="mt-16 bg-slate-900/80 rounded-2xl border border-slate-800 p-8 flex flex-col md:flex-row items-center justify-between gap-8">
         <div className="flex-1">
            ...
            <p className="text-slate-400 leading-relaxed">
              Upload your LinkedIn Connections (CSV) to unlock internal network value. Contribution to the ecosystem increases your proprietary score and priority for inbound introductions.
            </p>
         </div>
